    ...
    >
      <section className={styles.body}>
        ...
        <div className={styles.prose}>
          ...
          <h2 className="section-title">A Mutual Company.<br /><em>Trusted for Generations.&reg;</em></h2>
          ...
          <div className={styles.proseGrid}>
            <div className={styles.proseText}>
              ...
              <p>American Home Life has been <em>"Trusted for Generations"&reg;</em> and will be here for you today, and for generations to come.</p>
            </div>
